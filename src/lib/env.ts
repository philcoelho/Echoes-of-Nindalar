...
export type ServerAppEnv = Readonly<Record<RequiredServerEnvKey, string>>;
...
export function readServerEnv(source: EnvSource): ServerAppEnv {
	const missingKeys = validateKeys(source, REQUIRED_SERVER_ENV_KEYS);
